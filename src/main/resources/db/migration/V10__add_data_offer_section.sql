...
VALUES
    ...
    ('d3eebc99-9c0b-4ef8-bb6d-6bb9bd380a14', 'f6e1a183-0b6d-4f94-9e33-7a1b8e46050f', 'What you will get', 'LIST',
     'Benefits included in this boost'),
    ('e4eebc99-9c0b-4ef8-bb6d-6bb9bd380a15', 'f6e1a183-0b6d-4f94-9e33-7a1b8e46050f', 'Additional options', 'BLOCK',
     'Extra services you can add'),
    ('f5eebc99-9c0b-4ef8-bb6d-6bb9bd380a16', 'f6e1a183-0b6d-4f94-9e33-7a1b8e46050f', 'Related offers', 'RELATED_OFFERS',
     NULL),

    -- Секции для Starter Leveling
    ('06eebc99-9c0b-4ef8-bb6d-6bb9bd380a17', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Leveling details', 'LIST',
     'What includes in leveling service'),
    ('17eebc99-9c0b-4ef8-bb6d-6bb9bd380a18', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'FAQ', 'FAQ',
     'Frequently asked questions'),

    -- Секции для Mythic Raid Boost
    ('28eebc99-9c0b-4ef8-bb6d-6bb9bd380a19', 'ae9b14d1-1a86-4622-9760-eae403760917', 'Raid rewards', 'LIST',
     'Loot you will receive'),
    ('39eebc99-9c0b-4ef8-bb6d-6bb9bd380a20', 'ae9b14d1-1a86-4622-9760-eae403760917', 'Requirements', 'BLOCK',
...
VALUES
    ...
    (NULL, 'SIMPLE', 'Premium account status for 30 days', NULL, NULL, NULL, NULL,
    ...
    ('Mythic Raid Boost', 'RELATED_OFFER', 'Complete hardest raid content', 'ae9b14d1-1a86-4622-9760-eae403760917',
     '/images/raid1.jpg', 99.99, NULL, 'f5eebc99-9c0b-4ef8-bb6d-6bb9bd380a16'),
    ('Starter Leveling', 'RELATED_OFFER', 'Level up quickly', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11',
     '/images/leveling1.jpg', 29.99, NULL, 'f5eebc99-9c0b-4ef8-bb6d-6bb9bd380a16'),
    ...
    ('How long does it take?', 'ACCORDION', 'Usually takes 24-48 hours depending on class', NULL, NULL, NULL, NULL,
     '17eebc99-9c0b-4ef8-bb6d-6bb9bd380a18'),
    ('Is it safe?', 'ACCORDION', '100% safe with our professional boosters', NULL, NULL, NULL, NULL,
     '17eebc99-9c0b-4ef8-bb6d-6bb9bd380a18'),
    ...
    ('Consumables', 'SIMPLE', 'Bring your own flasks and potions', NULL, NULL, NULL, NULL,
